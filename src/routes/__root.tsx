...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "We help startups and businesses launch, automate, and scale through technology, design, and AI." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "4NodeTech" },
